...
and that it is also an *exhaustive and exclusive* measure of explicit knowledge, such that performance on the explicit task reflects all explicit but *no* implicit knowledge [@shanks_characteristics_1994;@reingold_interrelatedness_1990].
