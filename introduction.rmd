...
in contrast, implicit knowledge reflects regularities in the environment that may have been acquired without becoming aware of them [reference].
...
Finally, instead of aggregating data, we used hierarchical Bayesian extensions of all models [e.g., @rouder_hierarchical_2008; @rouder_introduction_2005; @klauer_hierarchical_2010].
