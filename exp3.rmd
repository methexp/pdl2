...
We analyzed generation performance by fitting $\mathcal{M}_1$ and computed model fit statistics to assess whether the model can account for the data. 
...
apa_barplot(data = exp3gen_rev, dv = "FOC.correct", id = "id", factors = c("Condition", "PD instruction"), ylim = c(0, 100), ylab = "Percentage correct", intercept = 20)
...
Results showed that practice increased the magnitude of the invariance violation (i.e., the I-E difference).
